...
\newcommand{\SubmissionDeadline}{September 27, 2024}
...
\newcommand{\GoogleDriveURL}{https://drive.google.com/drive/folders/1jANc3o6atOYbHyoJZ6b-j-nDlTknEiu-?usp=sharing}
...
\begin{enumerate}
  ...
  \item Write a program that calculates the area of a triangle given
  the base and height.
  \begin{align*}
...
\begin{enumerate}
  ...
  \item Inside the folder, upload the file of your submission.
    ...
    \end{quote}
  \item Deadline of submission is on \textbf{\SubmissionDeadline}.
